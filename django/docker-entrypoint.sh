...
try:\n\
  user = Profile.objects.create_superuser(open('/run/secrets/geonode_admin_username','r').read(),open('/run/secrets/geonode_admin_email','r').read(),open('/run/secrets/geonode_admin_password','r').read())\n\
